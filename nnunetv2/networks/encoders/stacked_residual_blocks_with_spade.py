...
from nnunetv2.networks.stacked_conv_blocks_with_spade import ConvSpadeDropoutNormReLU
...
class BasicBlockD(nn.Module):
    def __init__(self,
        ...
        self.conv1 = ConvSpadeDropoutNormReLU(conv_op, input_channels, output_channels, kernel_size, stride, conv_bias,
                                         norm_op, norm_op_kwargs, dropout_op, dropout_op_kwargs, nonlin, nonlin_kwargs)
        self.conv2 = ConvSpadeDropoutNormReLU(conv_op, output_channels, output_channels, kernel_size, 1, conv_bias, norm_op,
...
class StackedResidualBlocksWithSpade(nn.Module):
    def __init__(self,
                 n_blocks: int,
                 conv_op: Type[_ConvNd],
                 input_channels: int,
...
if __name__ == '__main__':
    ...
    stx = StackedResidualBlocksWithSpade(2, nn.Conv2d, 24, (16, 16), (3, 3), (1, 2),
