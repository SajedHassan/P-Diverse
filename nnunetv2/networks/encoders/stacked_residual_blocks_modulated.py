...
from nnunetv2.networks.stacked_modulated_conv_blocks import ModulatedConvDropoutNormReLU
...
class BasicBlockD(nn.Module):
    def __init__(self,
        ...
        self.conv1 = ModulatedConvDropoutNormReLU(conv_op, input_channels, output_channels, kernel_size, stride, conv_bias,
                                         norm_op, norm_op_kwargs, dropout_op, dropout_op_kwargs, nonlin, nonlin_kwargs)
        self.conv2 = ModulatedConvDropoutNormReLU(conv_op, output_channels, output_channels, kernel_size, 1, conv_bias, norm_op,
    ...
    def forward(self, x, type_embeddings):
        ...
        out = self.conv2(self.conv1(x, type_embeddings), type_embeddings)
        if self.apply_stochastic_depth:
...
class StackedResidualBlocksModulated(nn.Module):
    def __init__(self,
                 n_blocks: int,
                 conv_op: Type[_ConvNd],
                 input_channels: int,
...
if __name__ == '__main__':
    ...
    stx = StackedResidualBlocksModulated(2, nn.Conv2d, 24, (16, 16), (3, 3), (1, 2),
