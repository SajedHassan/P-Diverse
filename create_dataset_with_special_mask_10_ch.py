...
target_dataset_images_folder = '/home/sajed/thesis/nnUNet/nnunetv2/nnUNet_raw/Dataset016_NPC-special_mask_10_ch/imagesTr/'
target_dataset_labels_folder = '/home/sajed/thesis/nnUNet/nnunetv2/nnUNet_raw/Dataset016_NPC-special_mask_10_ch/labelsTr/'

index = 1

special_masks = [0.20231, 0.41452, 0.59891, 0.79954]
...
for annotator_idx, base_dataset_folder in enumerate(base_dataset_folders):
    ...
    for file_name in sorted_files_list:
        ...
        nib.save(nii_special_mask, os.path.join(target_dataset_images_folder, new_sample_base_path + '_0004.nii.gz'))
        nib.save(nii_special_mask, os.path.join(target_dataset_images_folder, new_sample_base_path + '_0005.nii.gz'))
        nib.save(nii_special_mask, os.path.join(target_dataset_images_folder, new_sample_base_path + '_0006.nii.gz'))
        
        nib.save(nii_special_mask, os.path.join(target_dataset_images_folder, new_sample_base_path + '_0007.nii.gz'))
        nib.save(nii_special_mask, os.path.join(target_dataset_images_folder, new_sample_base_path + '_0008.nii.gz'))
        nib.save(nii_special_mask, os.path.join(target_dataset_images_folder, new_sample_base_path + '_0009.nii.gz'))
        nib.save(nii_special_mask, os.path.join(target_dataset_images_folder, new_sample_base_path + '_0010.nii.gz'))
