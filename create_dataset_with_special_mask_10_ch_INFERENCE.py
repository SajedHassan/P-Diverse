...
target_dataset_images_folder = '/home/sajed/thesis/nnUNet/nnunetv2/nnUNet_input/Dataset016_NPC-special_mask_10_ch/'
...
for annotator_idx, base_dataset_folder in enumerate(base_dataset_folders):
    ...
    for file_name in sorted_files_list:
        ...
        for generated_AnnotatorIdx in range(0, len(base_dataset_folders)):
            ...
            special_mask = np.full(t1.shape, special_masks[generated_AnnotatorIdx])
