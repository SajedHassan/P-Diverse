...
target_dataset_folder = '/home/sajed/thesis/nnUNet/nnunetv2/nnUNet_input/Dataset022_NPC-3d_learnable_emb_spade_enc_dec/'
...
for annotator_idx, base_dataset_folder in enumerate(base_dataset_folders):
    ...
    for file_name in sorted_files_list:
        ...
        for generated_AnnotatorIdx in range(0, len(base_dataset_folders)):
            ...
            new_sample_base_path = 'NPC' + file_name_parts[1] + '-' + str(generated_AnnotatorIdx) + '_' + "{:03}".format(index)
            ...
            nib.save(nii_t1, os.path.join(target_dataset_folder, new_sample_base_path + '_0000.nii.gz'))
            nib.save(nii_t1c, os.path.join(target_dataset_folder, new_sample_base_path + '_0001.nii.gz'))
            nib.save(nii_t2, os.path.join(target_dataset_folder, new_sample_base_path + '_0002.nii.gz'))
