...
target_dataset_images_folder = '/home/sajed/thesis/MMIS/dataset/GENERATED_NPC_FROM_NNUNET_WITH_LEARNABLE_EMB_E32_SM_ES_DS_F5_P250_(2)/training_2d/'
generated_data_folder = '/home/sajed/thesis/nnUNet/nnunetv2/nnUNet_output/Dataset023_NPC-learnable_emb_spade_enc_dec_with_validation_250_epochs_2_annotators_PP'
...
for annotator_idx, base_dataset_folder in enumerate(base_dataset_folders):
    ...
    for file_name in sorted_files_list:
        ...
        file_path = os.path.join(original_dataset_folder, file_name)
        ...
        for generated_AnnotatorIdx in range(0, len(base_dataset_folders)):
            if (annotator_idx == generated_AnnotatorIdx) or (((annotator_idx + 1)%len(base_dataset_folders)) == generated_AnnotatorIdx):
                label = np.array(h5_file['label_a'+str(generated_AnnotatorIdx + 1)])
